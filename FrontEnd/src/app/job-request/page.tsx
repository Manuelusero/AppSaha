...
export default function JobRequest() {
  ...
  const handleSubmit = () => {
    ...
    alert('¡Último paso! Redirigiendo...');
  };

  return (
    <div className="min-h-screen bg-white flex flex-col">
      {/* Header */}
      <header className="px-4 py-3 sm:px-6 sm:py-4 flex items-center justify-between bg-white">
        ...
        <div className="px-4 py-2 rounded-full border border-[#244C87] text-[#244C87] text-sm">
      ...
      <main className="flex-1 flex flex-col items-center px-6" style={{ paddingTop: '164px' }}>
        <div className="w-full max-w-md">
          {/* Título */}
          <h1 className="text-center" style={{ fontFamily: 'Maitree, serif', fontSize: '40px', lineHeight: '100%', letterSpacing: '0%', color: '#244C87', fontWeight: 400, textAlign: 'center', marginBottom: '87px' }}>
            Explicanos tu problema
          </h1>

          {/* Campo de descripción */}
          <div style={{ marginBottom: '32px' }}>
            <label className="block mb-2" style={{ fontFamily: 'Maitree, serif', fontSize: '20px', lineHeight: '100%', letterSpacing: '0%', color: '#6B7280', fontWeight: 400 }}>
              ¿En qué podemos darte una mano?
            </label>
            <textarea
              value={descripcion}
          ...
          <div style={{ marginBottom: '32px' }}>
            ...
            <div 
              className="w-full px-4 py-8 rounded-3xl border-2 border-dashed border-gray-300 hover:border-[#244C87] transition-colors cursor-pointer"
            ...
            >
              <div className="flex flex-col items-center justify-center text-center">
                ...
                <p style={{ fontFamily: 'Maitree, serif', fontSize: '14px', color: '#6B7280' }}>
                  {foto ? foto.name : 'Arrastrá tu foto o hacé click para subirla'}
                </p>
              </div>
              <input
                id="file-upload"
          ...
          <div style={{ marginBottom: '48px' }}>
            ...
            <div className="relative">
              <input
                ...
                className="w-full px-5 py-4 rounded-full border-2 border-gray-300 focus:border-[#244C87] focus:outline-none text-gray-700"
              ...
              {mostrarCategorias && (
                <div className="absolute z-10 w-full mt-2 bg-white border-2 border-gray-200 rounded-2xl shadow-lg max-h-60 overflow-y-auto">
                  {servicios
                    .filter(s => s.toLowerCase().includes(categoria.toLowerCase()))
                    .map((servicio, idx) => (
                      <div
                        key={idx}
                        onClick={() => {
          ...
          <div className="flex justify-end">
            <button
              ...
              style={{ fontFamily: 'Maitree, serif', fontSize: '18px', color: '#244C87', fontWeight: 400, backgroundColor: '#BFC6EE33' }}
            >
              Último paso
            </button>
          </div>
      ...
      {/* Footer - Igual que en la landing */}
